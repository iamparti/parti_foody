...
if(!isset($_SESSION['rid'])){
   header("Location : login.php");
    ...
    $rid=$_SESSION['rid'];
$my=mysqli_query($conn,"SELECT *FROM restaurants WHERE restaurants_id='{$rid}' ");
...
<div id="divs">
   <form class="form-horizontal" action="<?php  $_SERVER['PHP_SELF']; ?>" method="POST" enctype="multipart/form-data">
    ...
    <input type="text" id="fname" name="pass" value="<?php echo $upass;?>" placeholder="Ex: DJckjf32">
    
    <br>   <label for="fname">Phone</label>
    <input type="text" id="fname" name="phone" value="<?php echo $phone;?>" placeholder="Ex: 565995">
...
if(isset($_POST['submit'])){
    ...
    $id=1;
    if(mysqli_query($conn,"UPDATE restaurants SET email='{$admin}',password='{$pass}',phone='{$phone}' WHERE restaurants_id='{$rid}' ")==1){
